...
import com.example.sscharquiz.Player;
import com.example.sscharquiz.PlayerList;
import com.example.sscharquiz.PlayersActivity;
import com.example.sscharquiz.QuizActivity;
...
public class AddActivity extends AppCompatActivity {
    ...
    private void setOwnerName(){
        ...
        adb.setPositiveButton("Ok", new AlertDialog.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                ...
                editor = getSharedPreferences("MyPrefsFile7", MODE_PRIVATE).edit();
    ...
    //confirm button to make sure user is satisfied
    //creates player, appends it to list, and updates stored list in preferences.
    private void confirmPicture(final Uri selectedImage) {
        ...
        myButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                prefs = getSharedPreferences("MyPrefsFile7", MODE_PRIVATE);
                Gson gson = new Gson();
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (photoFile != null) {
                photoURI = FileProvider.getUriForFile(this,
                        "com.example.sscharquiz.android.fileprovider",
                        photoFile);
